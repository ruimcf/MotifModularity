...
class Motif
{
    public:
        ...
        std::vector<int> getNeighboursWithOrder(int node);
        std::vector<int> getInNeighbours(int node);
        std::vector<int> getInNeighboursWithOrder(int node);
        std::vector<int> getOutNeighbours(int node);
        std::vector<int> getOutNeighboursWithOrder(int node);
